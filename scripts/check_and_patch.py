...
// 这段代码由 curiousbuddy skill 自动注入，请勿手动修改
...
def inject_mode_check(content: str) -> str:
    ...
    injection = """
// === ALIYUN HANDLER PATCH START ===
// curiousbuddy skill auto-injected
...
def create_patch_file(current_version: str, original: str, patched: str):
    ...
    with open(patch_file, "w") as f:
        ...
        f.write("# Generated by curiousbuddy skill\n\n")
        f.writelines(diff)
